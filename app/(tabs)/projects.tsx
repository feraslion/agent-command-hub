...
function ProjectCard({ project, wide, colors, onRun, onWorkspace, onGovernance, onRepositoryScan, isSubmitting }: { project: { id: number; name: string; code: string; status: keyof typeof statusLabel; progress: number; currentStage: string; updatedAt: Date }; wide: boolean; colors: ReturnType<typeof useColors>; onRun: () => void; onWorkspace: () => void; onGovernance: () => void; onRepositoryScan: () => void; isSubmitting: boolean }) {

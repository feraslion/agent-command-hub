...
export default function AlertsScreen() {
  ...
  const healthQuery = trpc.operationalHealth.get.useQuery();
  const health = getOperationalHealth(healthQuery.data ?? { queued: 0, activeLeases: 0, failedLast24h: 0, pendingApprovals: 0, readyRunners: 0, workerStatus: "unknown", workerHeartbeatAt: null, budgetPercent: 0 });
...
const styles = StyleSheet.create({
  ...
  operationalAlert: { backgroundColor: "#EAF8EE", borderColor: "#9FD5AC", borderRadius: 17, borderWidth: 1, marginTop: 14, padding: 13 }, operationalWarning: { backgroundColor: "#FFF5DF", borderColor: "#EAC56E" }, operationalCritical: { backgroundColor: "#FDEBED", borderColor: "#E6A1A9" }, operationalTop: { alignItems: "center", flexDirection: "row-reverse", justifyContent: "space-between" }, operationalTitle: { color: "#32345E", fontSize: 13, fontWeight: "900", textAlign: "right" }, operationalRefresh: { backgroundColor: "#FFFFFF", borderColor: "#D6D9E5", borderRadius: 9, borderWidth: 1, paddingHorizontal: 9, paddingVertical: 5 }, operationalRefreshText: { color: "#4F46E5", fontSize: 10, fontWeight: "900" }, operationalCopy: { color: "#5E6382", fontSize: 11, lineHeight: 17, marginTop: 7, textAlign: "right" },

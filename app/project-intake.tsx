...
export default function ProjectIntakeScreen() {
  ...
  const busy = archiveMutation.isPending || repositoryMutation.isPending || repositoryCheckMutation.isPending || buildMutation.isPending;
  const notice = useMemo(() => archiveMutation.error?.message || repositoryMutation.error?.message || repositoryCheckMutation.error?.message || buildMutation.error?.message || "", [archiveMutation.error, repositoryMutation.error, repositoryCheckMutation.error, buildMutation.error]);

...
بعد تطبيق التجاوز، أصبحت PRs #1 و#2 و#3 بحالة `CLEAN` وقابلة للدمج، مع نجاح فحص `TypeScript, tests, lint, and build`. يجب إعادة شرط الموافقة المستقلة إلى `1` فور توفر مراجع موثوق بصلاحية كتابة أو بعد اتخاذ قرار حوكمة بديل موثق.
